...
def run_tests(test_cases: abc.Iterable[TestCase], args):
    ...
    for tc in test_cases:
        ...
        try:
            ...
            print_output = 'always' if args.verbose or args.fail_fast else 'never'
            if not check_and_report_cmd_result(ret, before, print_output=print_output) and args.fail_fast:
                return
...
def check_and_report_cmd_result(result, began=None, print_output='on_fail'):
    success = True
    ...
    if print_output == 'always' or (print_output == 'on_fail' and not success):
        print("------------ stdout ------------")
        print(result.stdout)
        print("------------ stderr ------------")
        print(result.stderr)
